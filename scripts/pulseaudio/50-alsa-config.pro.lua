...
alsa_monitor.rules = {
  ...
  -- CUSTOM
  {
    ...
    apply_properties = {
      ["device.nick"] = "to-caller",
      ["device.description"] = "to-caller",
    },
  },
...

  {
    matches = {
      {
        { "node.name", "equals", "alsa_output.platform-snd_aloop.0.pro-output-0" },
      },
    },
    apply_properties = {
      ["node.disabled"]       = true,
  ...
  -- to caller
  {
    matches = {
      {
        { "node.name", "equals", "alsa_input.platform-snd_aloop.0.pro-input-0" },
      },
    },
    apply_properties = {
      ["node.nick"]              = "to-caller",
...

  {
    matches = {
      {
        { "node.name", "equals", "alsa_input.platform-snd_aloop.0.pro-input-1" },
      },
    },
    apply_properties = {
      ["node.disabled"]       = true,
