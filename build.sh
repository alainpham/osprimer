...
cat << EOF | chroot ${ROOTFS}
    apt install -y mpv vlc cmatrix nmon mesa-utils neofetch nitrogen 
EOF
...
cat << EOF | chroot ${ROOTFS}
    ...
    cd /home/$TARGET_USERNAME/wm/dwm-${DWM_VERSION} && make clean install
    cd /home/$TARGET_USERNAME/wm/st-${ST_VERSION} && make clean install
    cd /home/$TARGET_USERNAME/wm/dmenu-${DMENU_VERSION} && make clean install
