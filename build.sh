...
cat << EOF | chroot ${ROOTFS}
    ...
    DEBIAN_FRONTEND=noninteractive apt install -y git tmux vim curl rsync ncdu dnsutils bmon ntp ntpstat htop bash-completion gpg whois containerd cloud-guest-utils openssh-server console-setup
